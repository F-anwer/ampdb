    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "hydrolitic_activity",
                    models.FloatField(verbose_name="HydrolyticActivity"),
                ),
                ("mic_value", models.FloatField(verbose_name="MICValue")),
                (
                    "solubility",
                    models.CharField(max_length=256, verbose_name="Solubility"),
                ),
                ...
                (
                    "mol_weight_apliphatic",
                    models.FloatField(verbose_name="MolWeightAliphatic"),
                ),
                (
                    "mol_weight_aromatic",
                    models.FloatField(verbose_name="MolWeightAromatic"),
                ),
                (
                    "mol_weight_non_polar",
                    models.FloatField(verbose_name="MolWeightNonPolar"),
                ),
                ("mol_weight_polar", models.FloatField(verbose_name="MolWeightPolar")),
                (
                    "mol_weight_charged",
                    models.FloatField(verbose_name="MolWeightCharged"),
                ),
                ("mol_weight_basic", models.FloatField(verbose_name="MolWeightBasic")),
                (
                    "mol_weight_acidic",
                    models.FloatField(verbose_name="MolWeightAcidic"),
                ),
                ...
                (
                    "extracellular",
                    models.CharField(max_length=256, verbose_name="Extracellular"),
                ),
                (
                    "cytoplasmic",
                    models.CharField(max_length=256, verbose_name="Cytoplasmic"),
                ),
                (
                    "hydrophobic_plots",
                    models.FloatField(verbose_name="HydrophobicPlots"),
                ),
                ("hydropathy_plots", models.FloatField(verbose_name="HydropathyPlots")),
                (
                    "disulfide_end",
                    models.CharField(max_length=256, verbose_name="DisulfideEnd"),
                ),

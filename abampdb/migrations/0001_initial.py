# Generated by Django 4.0.5 on 2023-06-19 12:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sdock', models.ManyToManyField(related_name='sdock', to='abampdb.sdock')),
                ('starget_protein', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='abampdb.stargetproteins')),
            ],
        ),
        migrations.AddField(
            model_name='sdock',
            name='stargets',
            field=models.ManyToManyField(to='abampdb.stargetproteins'),
        ),
        migrations.CreateModel(
            name='Proteins',
            fields=[
